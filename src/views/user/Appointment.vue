<template>
  <div class="container md:min-h-[50vh] lg:min-h-[55vh] mx-auto px-10">
    ...
    <div v-if="showAppointment">
      ...
      <fwb-button @click="createAppointment" class="mt-5 md:ml-2 h-10 md:mt-9 w-full md:w-auto"
